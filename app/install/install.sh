...
sudo cp bo-PiServer /etc/init.d/bo-PiServer
sudo chmod 0755 /etc/init.d/bo-PiServer
sudo update-rc.d bo-PiServer defaults

mkdir /home/pi/Documents
sudo chmod 0755 /home/pi/Documents

mkdir /home/pi/Documents/bo-Pi
sudo chmod 0755 /home/pi/Documents/bo-Pi
